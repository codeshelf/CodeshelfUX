...
/***/ function(module, exports, __webpack_require__) {
	...
	var OrderDetailIBox = __webpack_require__(1);
	...
	function renderDetails(data) {
		var el = document.getElementById('orderDetailIBox');
		console.log(el);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var IBoxTitleBar = __webpack_require__(4).IBoxTitleBar;
	var IBoxTitleText = __webpack_require__(4).IBoxTitleText;
	var IBoxSection = __webpack_require__(4).IBoxSection;
	var DoughnutChart = __webpack_require__(5);

	var OrderDetailIBox = React.createClass({displayName: 'OrderDetailIBox',
		render: function() {
			var chartValues  = this.props.chartValues;
			var shorts = this.props.shorts;
			return (React.createElement("div", {className: "ibox float-e-margins"},
					React.createElement(IBoxTitleBar, null,
	                    React.createElement(IBoxTitleText, null, "Order Group shorter Burn Down")
	                ),
						  React.createElement(IBoxSection, null,
							  React.createElement(DoughnutChart, {dataValues: chartValues})
						  ),
						  React.createElement(IBoxSection, null,
							  shorts, " Shorts >"
						  ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var RClass = __webpack_require__(7);


	var IBoxTitleText = RClass(function() {
			return (React.createElement("h5", null, this.props.children));
		});

	var IBoxTitleTools = RClass(function() {
		return (
			React.createElement("div", {className: "ibox-tools dropdown"},
				React.createElement("a", {onclick: "{showhide();}"}, " ", React.createElement("i", {className: "fa fa-chevron-up"})),
				React.createElement("a", {className: "dropdown-toggle", href: true},
				React.createElement("i", {className: "fa fa-wrench"})
				),
				React.createElement("a", {onclick: "closebox()"}, React.createElement("i", {className: "fa fa-times"}))
			));
		});

	var IBoxTitleBar = RClass(function() {
			return (React.createElement("div", {className: "ibox-title"},
					this.props.children
					));
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DoughnutChart = RClass(function() {
		return (React.createElement("canvas", {style: {'height': 400, 'width': 350}}));
		},
		{
			componentDidMount: function() {
				var el = this.getDOMNode();
				var chart = new Doughnut(el, this.props.dataValues, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMComponent = __webpack_require__(18);
	var ReactDefaultInjection = __webpack_require__(19);
	var ReactInstanceHandles = __webpack_require__(20);
	var ReactLegacyElement = __webpack_require__(21);
	var ReactMount = __webpack_require__(22);
	var ReactMultiChild = __webpack_require__(23);
	var ReactPerf = __webpack_require__(24);
	var ReactPropTypes = __webpack_require__(25);
	var ReactServerRendering = __webpack_require__(26);
	var ReactTextComponent = __webpack_require__(27);

	var assign = __webpack_require__(28);
	var deprecated = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var monitorCodeUse = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flattenChildren = __webpack_require__(87);
	var instantiateReactComponent = __webpack_require__(49);
	var shouldUpdateReactComponent = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(88);
	var invariant = __webpack_require__(38);
	var joinClasses = __webpack_require__(94);
	var warning = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(15);
	var ReactLegacyElement = __webpack_require__(21);
	var ReactNativeComponent = __webpack_require__(95);
	var ReactEmptyComponent = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var containsNode = __webpack_require__(84);
	var focusNode = __webpack_require__(141);
	var getActiveElement = __webpack_require__(121);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(151);
	var getMarkupWrap = __webpack_require__(150);
	var invariant = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toArray = __webpack_require__(152);
