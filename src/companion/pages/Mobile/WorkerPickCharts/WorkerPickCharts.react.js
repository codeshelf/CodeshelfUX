...
import {acSetDefaultFilter, acSetFilter, acSearch, acRefresh,
 acMoveGrahToRight, acMoveGrahToLeft, acSetFilterAndRefresh, acToggleExpand} from "./store";
...
function mapDispatch(dispatch) {
  return bindActionCreators({acSetDefaultFilter, acSetFilter, acSearch,
   acRefresh, acMoveGrahToLeft, acMoveGrahToRight, acSetFilterAndRefresh, acToggleExpand}, dispatch);
}
