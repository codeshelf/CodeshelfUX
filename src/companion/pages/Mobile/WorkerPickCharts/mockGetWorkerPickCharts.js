...
export function getWorkerPickCharts(fitler) {
  return Promise.delay(Promise.resolve(data), 2000);
}
...
export function getWorkerPickByWorker(fitler) {
  return Promise.delay(Promise.resolve(workerData), 500);
}