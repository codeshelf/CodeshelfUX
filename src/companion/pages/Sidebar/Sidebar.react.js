...
class Sidebar extends React.Component {
  ...
  render() {
    const sidebarStyle = {...defaultStyles.sidebar, ...this.props.style.sidebar};
    const contentStyle = {...defaultStyles.content, ...this.props.style.content};
    const overlayStyle = {...defaultStyles.overlay, ...this.props.style.overlay};
    const useTouch = this.state.dragSupported && this.props.touch;
    const isTouching = this.isTouching();
    const rootProps = {
      style: {...defaultStyles.root, ...this.props.style.root},
    };
    let dragHandle;
    ...
    if (useTouch) {
      if (this.props.open) {
        ...
        const dragHandleStyle = {...defaultStyles.dragHandle, ...this.props.style.dragHandle};
