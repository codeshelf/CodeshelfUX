  ...
  grunt.initConfig({
	  ...
	  concat: {
		  ...
		  googlizeSlickGrid: {
			  options: {
/*
				  banner: "goog.provide('slickgrid.grid');\n"+
						  "goog.provide('slickgrid.cellcopymanager');\n"+
						  "goog.provide('slickgrid.cellselection'); \n"+
						  "goog.provide('slickgrid.cellrangeselector'); \n"+
						  "goog.provide('slickgrid.cellrangedecorator'); \n"+
						  "goog.provide('slickgrid.columnpicker');\n"+
						  "goog.provide('slickgrid.dataview');\n"+
						  "goog.provide('slickgrid.editors');\n"+
						  "goog.provide('slickgrid.formatters');\n"+
						  "goog.provide('slickgrid.pager');\n"+
						  "goog.provide('slickgrid.rowselection');\n"+
						  "goog.provide('slickgrid.rowmovemanager');\n"+
						  "goog.provide('extern.jquery.event.drag');\n"+
						  "goog.provide('extern.jquery.event.drop');\n"+
...
*/
			  ...
			  dest: 'lib/SlickGrid/slickgrid.goog.js'
		  }
	  },
...
*/
  ...
  grunt.registerTask('buildLibs', ['concat:googlizeSlickGrid']);
};
